...
vec.count()
vec.saveAsSequenceFile("/user/u0343930/YelpProject/data/vecModified")
...
userWeight.saveAsSequenceFile("/user/u0343930/YelpProject/data/uwModified")

f = open('logUwModified.txt', "a")
