...
for i in range(1,100):
	f.write('{"votes": {"funny": 0, "useful": 1, "cool": 0}, "user_id": "farmer'+ i + '", "review_id": "farmerReview' + i +'", "stars": 5, "date": "2015-01-02", "text": "", "type": "review", "business_id": "-sV52FN-D-I808tyRPEvwg"}\n')
