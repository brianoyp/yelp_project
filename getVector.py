...
vec = sc.sequenceFile("/user/u0343930/YelpProject/UserWeight10")
...
vec.saveAsSequenceFile("/user/u0343930/YelpProject/data/vecFullModified")
...
userWeight.saveAsSequenceFile("/user/u0343930/YelpProject/data/uwFullModified")

f = open('YelpProject/logUwFullmodified.txt', "a")
