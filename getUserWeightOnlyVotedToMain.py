...
rdd1 = sc.textFile('/user/u0343930/YelpProject/TransitionMatrixOnlyVotedToMain/part-00000')
rdd2 = sc.textFile('/user/u0343930/YelpProject/TransitionMatrixOnlyVotedToMain/part-00001')
...
vec.saveAsSequenceFile("/user/u0343930/YelpProject/data/vecOnlyVotedToMain")
...
userWeight.saveAsSequenceFile("/user/u0343930/YelpProject/data/uwOnlyVotedToMain")

f = open('YelpProject/logUwUnOnlyVotedToMain.txt', "a")
f.write(str(ListOfDiff))
